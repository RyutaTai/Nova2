...
private:
    ...
    static constexpr Ty PI_{ static_cast<Ty>(3.141592653589793) };  //  円周率π
...
private:
    ...
    {
        return static_cast<Ty>(angle * PI_<Ty> / _180<Ty>);
    }
...
public:
    ...
    [[nodiscard]] static inline Ty InOutSine(Ty time, Ty totaltime, Ty max = _1<Ty>, Ty min = _0<Ty>)
    {
        ...
        return -max / _2<Ty> *(std::cos(time * PI_<Ty> / totaltime) - 1) + min;
    }
